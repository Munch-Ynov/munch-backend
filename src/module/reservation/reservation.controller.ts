...
import { Body, Get, Post, Patch, Delete, Param } from "@nestjs/common/decorators/http";
// biome-ignore lint/style/useImportType: <explanation>
import { ReservationService } from "./reservation.service";
import { ExternalReservationCreateDto, ReservationCreateDto } from "src/data/dto/reservation/reservation-create.dto";
...
export class ReservationController {
  ...
  async createExternalReservation(@Body() reservation: ExternalReservationCreateDto) {
  ...
  async updateReservationStatus(@Param('reservationId') reservationId: string, @Body('status') status: ReservationStatus) {
  ...
  async updateReservation(@Param('reservationId') reservationId: string, @Body() reservation: ReservationUpdateDto) {
    return this.reservationService.updateReservation({ ...reservation, id: reservationId });
  }
